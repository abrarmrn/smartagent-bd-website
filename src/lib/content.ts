...
export const PRICING = [
  {
    ...
    en: {
      name: "Basic",
      tagline: "For new & growing pages",
      convos: "5,000 messages / month",
      includes: "",
      features: [
        "1 Facebook page",
        "24/7 Bangla replies",
    ...
    bn: {
      name: "বেসিক",
      tagline: "নতুন ও বাড়ন্ত পেজের জন্য",
      convos: "মাসে ৫,০০০ মেসেজ",
      includes: "",
      features: [
        "১টি ফেসবুক পেজ",
        "২৪/৭ বাংলা রিপ্লাই",
  ...
  },
  {
    ...
    en: {
      name: "Intermediate",
      tagline: "For busy, multi-channel pages",
      convos: "15,000 messages / month",
      includes: "Everything in Basic, plus —",
      features: [
        "FB + IG + WhatsApp",
        "Understands voice notes",
        "Reads product photos",
        "Comment auto-reply",
    ...
    bn: {
      name: "ইন্টারমিডিয়েট",
      tagline: "ব্যস্ত মাল্টি-চ্যানেল পেজের জন্য",
      convos: "মাসে ১৫,০০০ মেসেজ",
  ...
  },
  {
    ...
    en: {
      name: "Advanced",
      tagline: "For high-volume brands (20k–30k+)",
      convos: "30,000 messages (fair use)",
    ...
    bn: {
      name: "অ্যাডভান্সড",
      tagline: "হাই-ভলিউম ব্র্যান্ডের জন্য (২০k–৩০k+)",
      convos: "৩০,০০০ মেসেজ (ফেয়ার ইউজ)",
      includes: "ইন্টারমিডিয়েটের সব, সাথে —",
      features: [
        "Steadfast কুরিয়ার API",
        "লাইভ ইনভেন্টরি সিঙ্ক",
        "কাস্টম AI পারসোনা",
        "আনলিমিটেড ভয়েস-ভিশন",
